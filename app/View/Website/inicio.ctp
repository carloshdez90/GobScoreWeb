                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse pull-right">
                        <ul class="nav" id="top-navigation">
							...
							<li>
                                <a href="#" id="seguimiento" data-toggle="modal" data-target="#myModal">Seguimiento</a>
                            </li>
							<li>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <p style="color:darkslategray; text-align:justify">Para consultar el estado de su denuncia, introduzca su dirección de correo electrónico y el código de referencia que le fue enviado.</p>
 	<div class="row center">
		<div class="input-prepend">
		       ...
		       <input class="input-large" id="email-modal" type="text" placeholder="Correo electrónico">
	       </div>
		<br>
		<div class="input-prepend">
                       <span class="add-on" style="background-color:lightskyblue;">#</span>
                       <input class="input-large" id="cod-referencia-modal" type="text" placeholder="Código de Referencia">
               </div>
  ...
  <div class="modal-footer">
    ...
    <button class="btn btn-primary seguimiento-modal">Ingresar</button>
  </div>
</div>
